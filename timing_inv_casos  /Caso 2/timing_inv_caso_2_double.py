...
for i in range(N_C): 
    ...
    for N in NE:                              # N pertenece a la lista de NE.
        a = matriz_laplaciana(N, np.double)     # Multiplicacion de matrices.
        t1 = perf_counter()                   # Comienza el cronometro.        
        a_inv = sp.linalg.inv(a, overwrite_a = False)
...
plt.title('Timing_inv_caso_2_double' , fontweight = 'bold')
...
plt.savefig('timing_inv_caso_2_double.png' ,dpi = 300)    
