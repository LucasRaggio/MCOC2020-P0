...
for i in range(N_C): 
    ...
    for N in NE:                              # N pertenece a la lista de NE.
        a = matriz_laplaciana(N, np.half)     # Multiplicacion de matrices.
...
plt.title('Timing_inv_caso_2_half' , fontweight = 'bold')
...
plt.savefig('timing_inv_caso_2_half.png' ,dpi = 300)    
